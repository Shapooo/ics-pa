...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x24 */    IDEXW(E2G, and, 1), IDEX(E2G, and), EMPTY, EMPTY,
  ...
  /* 0x34 */	IDEXW(E2G, xor, 1), IDEX(E2G, xor), EMPTY, EMPTY,
  /* 0x38 */	IDEXW(G2E, cmp, 1), IDEX(G2E, cmp), IDEXW(E2G, cmp, 1), IDEX(E2G, cmp),
  /* 0x3c */	IDEXW(E2G, cmp, 1), IDEX(E2G, cmp), EMPTY, EMPTY,
  ...
  /* 0x84 */	IDEXW(G2E, test, 1), IDEX(G2E, test), IDEXW(G2E, xchg, 1), IDEXW(G2E, xchg)
  ...
  /* 0x9c */	EX(push), EX(pop), EMPTY, EMPTY,
...
/*2 byte_opcode_table */
  ...
  /* 0x00 */	IDEXW(E, gp6, 2), IDEX(gp7_E, gp7), EMPTY, EMPTY,
